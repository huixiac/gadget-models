...
likelihood_actions <- list(
  ...
  g3l_abundancedistribution(
    ...
    fleets = list(),
    stocks = stocks,
    g3l_distribution_surveyindices_log(alpha = g3_stock_param(imm_stock, 
                                                              id = 'species',
                                                              param_name = 'si_alpha_1', 
                                                              bound_param = FALSE),
                                       beta = g3_stock_param(imm_stock, 
                                                             id = 'species',
                                                             param_name = 'si_beta_1', 
                                                             bound_param = FALSE)),
    nll_breakdown = nll_breakdown,     
    report = lik_report),
  ...
  g3l_abundancedistribution(
    ...
    g3l_distribution_surveyindices_log(alpha = g3_stock_param(imm_stock, 
                                                              id = 'species',
                                                              param_name = 'si_alpha_2a', 
                                                              bound_param = FALSE),
                                       beta = g3_stock_param(imm_stock, 
                                                             id = 'species',
                                                             param_name = 'si_beta_2a', 
                                                             bound_param = FALSE)),
    nll_breakdown = nll_breakdown,     
    report = lik_report),
