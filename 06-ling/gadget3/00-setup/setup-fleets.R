    ...
    lln %>%
      g3a_predate_fleet(stocks,
                        suitabilities = 
                          stocks %>% 
                          set_names(.,map(.,'name')) %>% 
                          map(function(x) g3_suitability_exponentiall50(g3_stock_param(x, 'species', 'lln.alpha', setup_options$bound_params),
                                                                        g3_stock_param(x, 'species', 'lln.l50', setup_options$bound_params))),
    ...
    bmt %>%
      g3a_predate_fleet(stocks,
                        suitabilities = 
                          stocks %>% 
                            set_names(.,map(.,'name')) %>% 
                            map(function(x) g3_suitability_exponentiall50(g3_stock_param(x, 'species', 'bmt.alpha', setup_options$bound_params),
                                                                          g3_stock_param(x, 'species', 'bmt.l50', setup_options$bound_params))),
    ...
    gil %>%
      g3a_predate_fleet(stocks,
                        suitabilities = 
                          stocks %>% 
                            set_names(.,map(.,'name')) %>% 
                            map(function(x) g3_suitability_exponentiall50(g3_stock_param(x, 'species', 'gil.alpha', setup_options$bound_params),
                                                                          g3_stock_param(x, 'species', 'gil.l50', setup_options$bound_params))),
    ...
    igfs %>%
      g3a_predate_fleet(stocks,
                        suitabilities = 
                          stocks %>% 
                            set_names(.,map(.,'name')) %>% 
                            map(function(x) g3_suitability_exponentiall50(g3_stock_param(x, 'species', 'igfs.alpha', setup_options$bound_params),
                                                                          g3_stock_param(x, 'species', 'igfs.l50', setup_options$bound_params))),
